  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEmailChanging) {
        ...
        // Sign the user out while the email change is pending verification
        await logout();

        // Return to login with a message explaining the verification process
        router.push('/login?message=email-verification');
