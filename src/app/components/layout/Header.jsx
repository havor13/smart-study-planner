        ...
        <div className="flex items-center gap-3">
          ...
          >
            <div className="relative">
              <div className="w-10 h-10 bg-linear-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center text-white font-semibold shadow-lg shadow-blue-200 group-hover:scale-105 group-hover:shadow-xl transition-all duration-300">
                {getInitials()}
              </div>
